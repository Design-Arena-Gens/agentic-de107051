export default function Footer() {
  return (
    <footer className="bg-slate-900 border-t border-gold/20 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-gold">Chronos Elite</h3>
            </div>
            <p className="text-gray-400">
              Your trusted destination for authentic luxury timepieces since 2024.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-gold transition">Our Collection</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-gold transition">Shipping Info</a></li>
              <li><a href="#" className="hover:text-gold transition">Returns</a></li>
              <li><a href="#" className="hover:text-gold transition">Warranty</a></li>
              <li><a href="#" className="hover:text-gold transition">Authentication</a></li>
            </ul>
          </div>
